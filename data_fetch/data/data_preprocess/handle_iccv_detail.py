...
for year in range(2001, 2019, 2):
    with open(f'organized/iccv{year}_paper_infos.json', 'r') as f:
...
for year in paper_infos:
    ...
    for paper in papers:
        ...
        #     continue
        new_paper_infos[year][paper['id']] = paper_to_new_paper(paper, year)

with open(f'paper_detail.json', 'w') as f:
